...
const AddAlbum = () => {
    ...
    return loading ? (
        <div className='grid place-items-center min-h-[80vh]'>
            <div className='w-14 h-14 place-self-center border-4 border-gray-400 border-t-green-800 rounded-full animate-spin'/>
        </div>
    ) : (
        <form onSubmit={onSubmitHandler} className='flex flex-col items-start gap-6 text-gray-600'>
            ...
            <div className='flex flex-col gap-4'>
                ...
                <label htmlFor='image'>
                    <img src={image ? URL.createObjectURL(image) : assets.upload_area} className='w-24 cursor-pointer' alt='upload-song' />
                </label>
            </div>
