...
const Sidebar = () => {
    return (
        <div className='bg-[#003a10] min-h-screen pl-[4vw]'>
            <img src={assets.logo} className='mt-5 w-[20vw] hidden sm:block' alt='logo' />
            <img src={assets.logo_small} className='mt-5 w-[10vw] mr-5 sm:hidden block' alt='small-logo' />
            ...
            <div className='flex flex-col gap-5 mt-10'>
                ...
                <NavLink to='/list-album' className='flex items-center gap-2.5 text-gray-800 bg-white border border-black p-2 pr-[max(8vw, 10px)] drop-shadow-[-4px_4px_#00ff58] text-sm font-medium'>
                    <img src={assets.album_icon} className='w-5 ' alt='add_song' />
